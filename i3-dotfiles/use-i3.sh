...
sudo pacman -S light acpi pavucontrol pulseaudio pamixer thunar tumbler gvfs gvfs-smb udiskie dunst ttf-roboto-mono ttf-dejavu awesome-terminal-fonts --needed
